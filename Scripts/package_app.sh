...
DOWNLOAD_DIR="${CFST_DOWNLOAD_DIR:-$DIST_DIR}"
CFST_VERSION="v2.3.5"
...
if [[ -n "$LOCAL_CFST_ARM64_DIR" ]]; then
  ...
  ARM_DIR="$(download_asset cfst_darwin_arm64.zip,CloudflareST_darwin_arm64.zip 0623f6d24c939e3d3716f556f4d39c7b8781cf6600ee838a1b64e6b2fe4609dc)"
fi
